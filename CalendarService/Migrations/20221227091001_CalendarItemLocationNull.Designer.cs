...
namespace CalendarService.Migrations
{
    ...
    [Migration("20221227091001_CalendarItemLocationNull")]
    partial class CalendarItemLocationNull
    {
            ...
            modelBuilder.Entity("CalendarService.Models.AppRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ConcurrencyStamp = "80763544-9597-437c-bc5a-60b7e96edd5e",
                            Name = "Admin",
                        ...
                        {
                            Id = 2,
                            ConcurrencyStamp = "1cb1d5c4-f541-4272-9072-da11f82e33b1",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("CalendarService.Models.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEOniW11BAt9rfl3ZeDYANb8TDOF+49XSYdel+QDDO+qepSyjJflaTQLwfBbxtcO5zg==",
                            UserName = "admin"
                        });
                });
